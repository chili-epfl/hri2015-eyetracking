...
Controlling robot with gaze \cite{bhuiyan2004tracking}

\subsection{Eye Tracking as a tool to Assess Interaction Algorithms}

Physiological and subjective evaluation of a human-robot object hand-over task  \cite{dehais2011physiological}

...
\begin{figure}
    \centering
    \includegraphics[width=0.9\linewidth]{nokia.jpg}
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\linewidth]{heat-map-good-ex}
    \caption{Example heat map for a MOOC student who performed well in the posttest.
    source: \cite{sharma2014how}}
    \label{heatMapGood}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=0.9\linewidth]{heat-map-bad-ex}
    \caption{Example heat map for a MOOC student who performed poor in the posttest.

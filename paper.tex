...
\subsection{Eye Tracking as a tool to Measure Joint Attention}
...
summarised in~\cite{duchowski2007eye}. Following are the two gaze measures, derived
...
\section{Field of Application and Deployment}
...
participants but also to analyse HRI situations. The prime advantage of using
...
Another advantage of using mobile eye-tracking to assess HRI situations, is that the data provides direct and noise free access to the users' attention. While in other physiological measures for attention, such as EEG, the data has a lot of noise and the relation to the attention is very task-specific.

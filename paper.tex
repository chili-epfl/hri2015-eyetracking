...
Thymio II~\cite{riedo2012two} with 52 participants. The participants observed the robot
...
from the robot's sensors were visualised on the robot's body using LEDs
in two different ways in the two experimental conditions and there was
no sensor data visualisation in the control condition. We found that the
sensor data visualisation has an impact on the gaze patterns and the
...
behavior and its visual actuators can help in maximising the learning
